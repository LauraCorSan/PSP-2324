...
public class PrincipalCarreraS {
    ...
    private static final int Corredores = 3;
    ...
    public static void main(String[] args) {
        ...
        CorredorS[] Arraycorredores = new CorredorS[Corredores];
        for (int i = 0; i < Arraycorredores.length; i++) {
            Arraycorredores[i] = new CorredorS(TOTAL_CARRERA, START_DORSAL + i, salida);
        }
