...
int main()
{
    ...
    { // Código del proceso hijo
        ...
        close(fd2[READ]); // El hijo no leera en el pipe2, así que cerramos el descriptor de lectura
    ...
    else
    {
        ...
        n2 = rand() % 100;
        n3 = rand() % 100;
        close(fd1[READ]); // El padre no leerá del pipe1, así que cerramos el descriptor de lectura
        ...
        close(fd2[WRITE]); // El padre no escribira en el pipe2, así que cerramos el descriptor de escritura
